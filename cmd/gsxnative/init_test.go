...
func TestInitScaffoldsNativeProject(t *testing.T) {
	...
	assertFileContains(t, filepath.Join(dir, "README.md"), "gsxnative store-plan --artifact-manifest build/gsxnative-artifacts.json --output build/store-plan.json")
	...
	assertFileContains(t, filepath.Join(dir, "ios/SampleApp/Native/Auth.swift"), "static func session(baseURL: String")
	assertFileContains(t, filepath.Join(dir, "ios/SampleApp/Native/Auth.swift"), "GSXKeychainTokenStore()")
	assertFileContains(t, filepath.Join(dir, "ios/SampleApp/Native/Auth.swift"), ".oauth(provider: provider")
	assertFileContains(t, filepath.Join(dir, "ios/SampleApp/Native/Auth.swift"), ".webAuthn(")
	...
	assertFileContains(t, filepath.Join(dir, "ios/SampleApp/Native/Observability.swift"), "GSXRedactingCrashReporter(GSXDiagnosticsCrashReporter())")
	...
	assertFileContains(t, filepath.Join(dir, "android/app/build.gradle.kts"), "buildConfigField(\"String\", \"GSX_SERVER_URL\"")
	...
	assertFileContains(t, filepath.Join(dir, "android/app/src/main/kotlin/com/example/sample/Auth.kt"), "GSXKeystoreTokenStore(context)")
	assertFileContains(t, filepath.Join(dir, "android/app/src/main/kotlin/com/example/sample/Auth.kt"), "GSXAuthStrategy.OAuth")
	assertFileContains(t, filepath.Join(dir, "android/app/src/main/kotlin/com/example/sample/Auth.kt"), "GSXAuthStrategy.WebAuthn")
	...
	assertFileContains(t, filepath.Join(dir, "android/app/src/main/kotlin/com/example/sample/Observability.kt"), "GSXRedactingCrashReporter(GSXDiagnosticsCrashReporter())")
