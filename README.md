...
- **Native bridge and escape hatches:** generated bridge specs, typed Swift/Kotlin bridge callers, capability manifests, `/api/capabilities` negotiation, runtime capability providers, bridge service registries, and scaffolded native-module skeletons are present. Remaining work: secure local capability implementations, native service dispatch envelopes, and stricter `//gosx:native <target>` implementation checks.
